...
internal static class JevResilience
{
    public static readonly TimeSpan BaseDelay = TimeSpan.FromSeconds(0.5);

    public static readonly TimeSpan MaxDelay = TimeSpan.FromSeconds(5);

    public static void Configure(ResiliencePipelineBuilder<HttpResponseMessage> builder, JevOptions options)
    {
    ...
    public static DelegatingHandler CreateHandler(JevOptions options)
    {
